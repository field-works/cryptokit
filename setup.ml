...
(* OASIS_START *)
(* DO NOT EDIT (digest: 32148bfa930416e4931dddf780be30b1) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["CryptokitBignumOld"; "Cryptokit"];
                      lib_pack = false;
     ...
     oasis_digest = Some "\007X\017\030l\028\220\002\207^S0\201L\249;";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
